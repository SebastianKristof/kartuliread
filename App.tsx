...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center p-4 md:p-8">
      ...
      <main className="w-full max-w-2xl bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-indigo-50 border-t-8 border-t-indigo-500">
        {/* Progress Header */}
        <div className="bg-indigo-50/30 p-6 border-b border-indigo-100">
        ...
        {/* Exercise Area */}
        <div className="p-8 md:p-12 flex flex-col items-center min-h-[450px] justify-center relative bg-white">
          {currentExercise ? (
            <div className="w-full text-center space-y-12 animate-in fade-in zoom-in duration-500">
              <div ref={georgianContainerRef} className="flex flex-col items-center justify-center min-h-[160px] w-full p-[10%]">
                <span
                  ref={georgianTextRef}
              ...
              <div className="min-h-[110px] flex flex-col items-center justify-center bg-slate-50/50 rounded-3xl p-6 border border-slate-100">
                {showTranscription ? (
      ...
      {/* History Grid */}
      <section className="w-full max-w-2xl mt-12 mb-16 px-2">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 gap-3">
          ...
          {history.length === 0 && (
            <div className="col-span-full py-16 text-center text-slate-300 font-black uppercase tracking-[0.3em] text-[10px] border-4 border-dotted border-slate-100 rounded-[3rem]">
